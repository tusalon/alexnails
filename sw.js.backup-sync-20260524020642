...
const CACHE_NAME = 'alexnails-v25';
const urlsToCache = [
  '/alexnails/',
  '/alexnails/index.html',
  '/alexnails/admin.html',
  '/alexnails/admin-login.html',
  '/alexnails/calendar.html',
  '/alexnails/setup-wizard.html',
  '/alexnails/editar-negocio.html',
  '/alexnails/manifest.json',
  '/alexnails/icons/icon-72x72.png',
  '/alexnails/icons/icon-96x96.png',
  '/alexnails/icons/icon-128x128.png',
  '/alexnails/icons/icon-144x144.png',
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/alexnails/icons/icon-192x192.png');
          }
...
console.log('✅ Service Worker configurado para Alex_Nails');
